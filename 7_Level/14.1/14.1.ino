...
{ 
  ...
  while(1)                                                          //Calling "while" loop
  {
    ...
    for (right_hand = 60; right_hand >= 35; right_hand--)           //For loop will be running as long as "right_hand" is greater or equal to 35 (right_foot is incrementing itself and in the beginning is set to 60)       
    {
      convert();                                                    //"convert" function is being called
    }
    _delay_ms(20);                                                  //Delay of 20ms
