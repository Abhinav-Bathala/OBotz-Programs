...
{ 
  ...
  {
    for (left_hand = 135; left_hand <= 160; left_hand++)           //For loop will be running as long as "left_hand" is less or equal to 160 (left_hand is decrementing itself and in the beginning is set to 135)
    {
