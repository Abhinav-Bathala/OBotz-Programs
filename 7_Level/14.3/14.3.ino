...
{ 
  ...
  for (left_hand = 160; left_hand >= 135; left_hand--)           //For loop will be running as long as "left_hand" is greater or equal to 135 (right_foot is incrementing itself and in the beginning is set to 160)       
    {
      convert();                                                    //"convert" function is being called
    }
    _delay_ms(20);                                                  //Delay of 20ms

   for (right_hand = 35; right_hand <= 60; right_hand++)           //For loop will be running as long as "right_hand" is less or equal to 60 (right_foot is decrementing itself and in the beginning is set to 35)
    {
      convert();                                                    //"convert" function is being called
    }
    _delay_ms(20);                                                  //Delay of 20ms
  ...
  {
    for ((left_hand = 160; left_hand >= 135; left_hand--) && (right_hand = 35; right_hand <= 60; right_hand++))    
    {
      convert();                                                    //"convert" function is being called
    }
    _delay_ms(20);                                                  //Delay of 20ms

    for ((left_hand = 135; left_hand <= 160; left_hand++) && (right_hand = 60; right_hand >= 35; right_hand--))         
    {
      convert();                                                    //"convert" function is being called
    }
    _delay_ms(20);                                                  //Delay of 20ms   
