...
int count_angle, count_angle1, count_angle2, count_angle3, count_angle4, count_angle5, neck;        //Indroducing multiple "count_angle" variables
...
{ 
  ...
  while(1)
  {
    ...
    for (neck = 70; neck <= 110; neck = neck + 2)
    {
      convert();
    } 
...
{
  count++;
  if(count <= count_angle6)          //Head Motor
  {
    setbit(PORTD, bitn(1));
  }
